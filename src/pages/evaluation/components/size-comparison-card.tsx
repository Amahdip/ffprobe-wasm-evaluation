    ...
    <section className="card">
      ...
      <div className="table-container">
        <table className="workout-table">
          <thead>
            <tr>
              <th style={{ width: '30%', whiteSpace: 'nowrap' }}>Engine</th>
              <th style={{ width: '15%', whiteSpace: 'nowrap' }}>Raw</th>
              <th style={{ width: '15%', whiteSpace: 'nowrap' }}>Gzip</th>
              <th style={{ width: '20%', whiteSpace: 'nowrap' }}>SAB / COOP-COEP</th>
      ...
      <ul className="recommendation-list" style={{ marginTop: 16 }}>
        ...
        <li>Rebuilt full baseline from source is ~2.2 MB raw / ~783 KB gzip (still needs pthreads + COOP/COEP).</li>
        <li>Optimized minimal-metadata is ~1.1 MB raw / ~510 KB gzip and removes SharedArrayBuffer requirements.</li>
      </ul>
    </section>
  )
}
